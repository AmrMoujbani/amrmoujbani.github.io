export default function Hero() {
  return (
    <section id="hero" className="min-h-screen flex items-center px-6 pt-16 relative overflow-hidden">
      {/* Background glow */}
      ...
      <div className="max-w-6xl mx-auto w-full py-24 relative">
        ...
        <h1 className="font-display leading-none mb-4 animate-fade-up opacity-0-init"
          style={{ animationDelay: '100ms', animationFillMode: 'forwards' }}>
          <span className="block text-6xl md:text-8xl font-extrabold text-zinc-900 dark:text-white">
            Amr
          </span>
          <span className="block text-6xl md:text-8xl font-extrabold gradient-name">
            Moujbani
          </span>
        </h1>

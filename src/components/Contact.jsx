export default function Contact() {
  return (
    <section id="contact" className="py-24 px-6 border-t border-zinc-200 dark:border-zinc-800/60">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-4">
            <div className="p-5 rounded-xl border border-zinc-200 dark:border-zinc-800 flex items-center gap-4">
              <span className="text-3xl">🇱🇺</span>
              <div>
                <p className="font-display font-semibold text-zinc-900 dark:text-white">Based in Luxembourg</p>
                <p className="text-sm text-zinc-500 dark:text-zinc-400">Open to remote & on-site roles in Luxembourg</p>
              </div>
            </div>
            <div className="p-5 rounded-xl border border-zinc-200 dark:border-zinc-800 flex items-center gap-4">
              <span className="text-3xl">⏱️</span>
              <div>
                <p className="font-display font-semibold text-zinc-900 dark:text-white">Passively open</p>
                <p className="text-sm text-zinc-500 dark:text-zinc-400">Not urgently looking — but always happy to hear about strong opportunities</p>
              </div>
            </div>
            <div className="p-5 rounded-xl border border-zinc-200 dark:border-zinc-800 flex items-center gap-4">
              <span className="text-3xl">💬</span>
              <div>
                <p className="font-display font-semibold text-zinc-900 dark:text-white">Languages</p>
                <p className="text-sm text-zinc-500 dark:text-zinc-400">English · French · Arabic</p>
              </div>
            </div>
          </div>
